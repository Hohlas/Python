...
pairs = [
    {
        'base': 'BTC',
        'quote': 'ETH',
        'offers_amount': 5, # Сколько предложений из стакана берем для расчета средней цены # Максимум 1000. Допускаются следующие значения:[5, 10, 20, 50, 100, 500, 1000]
        ...
        'quote': 'BNB',
        'offers_amount': 5, # Сколько предложений из стакана берем для расчета средней цены  # Максимум 1000. Допускаются следующие значения:[5, 10, 20, 50, 100, 500, 1000]
        'spend_sum': 0.05,  # Сколько тратить base каждый раз при покупке quote
        'profit_markup': 0.01, # Какой навар нужен с каждой сделки? (0.001 = 0.1%)
    }, {
        'base': 'BTC',
        'quote': 'CND',
...
USE_BNB_FEES = True  # Если вы решите не платить комиссию в BNB, то установите в False. Обычно делать этого не надо
